...
//    {
//        // Declare private instances of the Ingredient and Steps classes.
...
//        public void ScaleRecipe(List<Ingredient> ingList, double factor)
//        {
...
//                // Loop through the list of Ingredient objects and scale the quantity of each ingredient by the scale factor.
...
//        public void ResetNewQuantities(List<Ingredient> ingList)
//        {
//            // Check if there are any ingredients to reset.
//            // If not, display an error message and return.
//            if (ingList != null && ingList.Count > 0)
//            {
//                // Loop through the list of Ingredient objects and reset the quantity, unit of measurement, and calories of each ingredient to their original values.
//                foreach (var ingredient in ingList)
//                {
...
//        // It resets the Ingredient and Steps objects to new instances.
//        public void ClearAllData()
//        {
//            // Reset the Ingredient and Steps objects to new instances.
//            ing = new Ingredients();
//            stp = new Steps();
//        }
//    }
